function SpecifiedArgs=vCCRMnparseArgs(ListenerName,varargin)
...
p.addParamValue('Video', 1, @isnumeric); %  %13.01.25 recoded this to make more logical sense 0 = no video, 1 is full video, 2 interupted
p.addParamValue('tracks', 2, @isnumeric);
p.addParamValue('MaskerFile', 'nounMaskers.mat', @ischar);
